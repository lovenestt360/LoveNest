-- 1. LOVE STREAK TABLE (NEW SOURCE OF TRUTH - Standardized to plural)
...
CREATE POLICY "Members can view their own love_streaks"
...
RETURNS TRIGGER AS $$
BEGIN
    PERFORM public.fn_check_streak(NEW.couple_space_id);
    RETURN NEW;
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;
