...
import { BookOpen, Heart, Leaf, Zap, Droplets, Salad, Footprints, Moon, AlertTriangle, type LucideIcon } from "lucide-react";
...
const HEALTH_TIPS: { Icon: LucideIcon; iconCls: string; title: string; body: string }[] = [
    { Icon: Droplets, iconCls: "text-blue-500", title: "Hidratação", body: "Bebe pelo menos 2L de água por dia. O jejum não exclui a água — ela é essencial para evitar tonturas e dores de cabeça." },
    { Icon: Salad, iconCls: "text-green-600", title: "Refeições leves", body: "Opta por sopas, legumes cozidos, arroz ou grão. Evita refeições pesadas que causam sonolência." },
    { Icon: Footprints, iconCls: "text-primary", title: "Caminhadas", body: "Uma caminhada de 20 min por dia ajuda na disciplina mental e no bem-estar durante o jejum." },
    { Icon: Moon, iconCls: "text-indigo-500", title: "Descanso", body: "O jejum combinado com privação de sono é difícil. Prioriza 7-8 horas de sono para manter a concentração." },
    { Icon: AlertTriangle, iconCls: "text-orange-500", title: "Sinais de alerta", body: "Tonturas fortes, náuseas ou palpitações são sinal para comer ou consultar um médico. O jejum não deve prejudicar a saúde." },
];

const MINI_CHALLENGES = [
    { days: 3, label: "3 dias sem açúcar", target: "alimentar" },
    { days: 2, label: "2 dias sem redes sociais", target: "digital" },
    { days: 5, label: "5 dias de oração diária", target: "espiritual" },
    { days: 7, label: "1 semana sem reclamar", target: "comportamental" },
    { days: 3, label: "3 dias de silêncio pessoal", target: "mente" },
    { days: 10, label: "10 dias sem carne", target: "alimentar" },
];
                ...
                <div className="space-y-3">
                    {HEALTH_TIPS.map(tip => (
                        <div key={tip.title} className="flex gap-3">
                            <tip.Icon className={cn("h-4 w-4 mt-0.5 shrink-0", tip.iconCls)} />
                            <div>
