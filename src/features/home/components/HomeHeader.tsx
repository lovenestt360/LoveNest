...
export function HomeHeader({ me, partner, today }: HomeHeaderProps) {
  return (
    <header className="space-y-4 pt-2 text-center overflow-hidden w-full">
      <div className="flex items-center justify-center gap-2 md:gap-6 px-2">
        <div className="relative shrink-0">
          <Avatar className="h-14 w-14 md:h-20 md:w-20 ring-4 ring-white/30 shadow-2xl transition-transform active:scale-95 duration-500">
            {me?.avatarUrl ? (
        ...
        <div className="flex flex-col items-center gap-1 px-1 md:px-4 shrink-0 min-w-0">
          <div className="flex items-center gap-1">
            <Heart className="h-3 w-3 md:h-4 md:w-4 text-primary fill-primary animate-pulse" />
