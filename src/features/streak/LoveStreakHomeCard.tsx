...
export function LoveStreakHomeCard() {
  ...
  const getStatusMessage = () => {
    if (bothToday) return "A vossa chama arde! 🔥";
    if (dailyStatus?.me_active) return "Estás à espera do par ✨";
    if (dailyStatus?.partner_active) return "O teu par está à tua espera ❤️";
    return "Mantenham a chama viva ✨";
  };
